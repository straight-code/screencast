...
def main():
    try:
        lcd_print(top="## Welcome to ##", bottom="## straight-code ##", delay=20)
...
if __name__ == "__main__":
    ...
    hosts = {
        'Internet': '8.8.8.8',
        'Router': '192.168.8.1',
        'This Server': '192.168.8.107',
        '(R720) VMWare': '192.168.8.175',

    }
    # customizable dict of unique, netcatable services
    services = {
        'SSH': {'ip': '192.168.8.107', 'port': '22'},
        'WEBPAGE': {'ip': '192.168.8.107', 'port': '80'},
        'VM1': {'ip': '192.168.8.112', 'port': '22'}
    }
    main()
